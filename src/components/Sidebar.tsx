    ...
    return <>
        <div className={`sidebar ${mobileOpen ? "mobile-open" : ""}`}>
            ...
            <div className="main-content">
                ...
                <div className="section-icon" onClick={() => navigate("mainContent")}>
                ...
                <div className="section-icon" onClick={() => navigate("projects")}>
                ...
                <div className="section-icon" onClick={() => navigate("skills")}>
                ...
                <div className="section-icon" onClick={() => navigate("certifications")}>
                ...
                <div className="section-icon" onClick={() => navigate("awards")}>
                ...
                <div className="section-icon" onClick={() => navigate("contactInfo")}>
