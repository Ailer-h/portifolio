...
const Sidebar = () => {
    ...
    const { theme, language, toggleTheme, toggleLanguage, t } = useUserPreferences()
        ...
        <div className="sidebar">
            <div className="header">
                ...
                <div className="controls">
                    ...
                    >
                        {theme === 'dark' ? (
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-moon" viewBox="0 0 16 16"><path d="M6 .278a.77.77 0 0 1 .08.858 7.2 7.2 0 0 0-.878 3.46c0 4.021 3.278 7.277 7.318 7.277q.792-.001 1.533-.16a.79.79 0 0 1 .81.316.73.73 0 0 1-.031.893A8.35 8.35 0 0 1 8.344 16C3.734 16 0 12.286 0 7.71 0 4.266 2.114 1.312 5.124.06A.75.75 0 0 1 6 .278"/></svg>
                        ) : (
            ...
            <div className="main-content">
                ...
                <div className="section-icon" onClick={() => ScrollToSection("mainContent")}>
                ...
                <div className="section-icon" onClick={() => ScrollToSection("projects")}>
                ...
                <div className="section-icon" onClick={() => ScrollToSection("skills")}>
                ...
                <div className="section-icon" onClick={() => ScrollToSection("certifications")}>
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-mortarboard" viewBox="0 0 16 16"><path d="M8.211 2.047a.5.5 0 0 0-.422 0l-7.5 3.5a.5.5 0 0 0 .025.917l7.5 3a.5.5 0 0 0 .372 0L14 7.14V13a1 1 0 0 0-1 1v2h3v-2a1 1 0 0 0-1-1V6.739l.686-.275a.5.5 0 0 0 .025-.917zM8 8.46 1.758 5.965 8 3.052l6.242 2.913z"/><path d="M4.176 9.032a.5.5 0 0 0-.656.327l-.5 1.7a.5.5 0 0 0 .294.605l4.5 1.8a.5.5 0 0 0 .372 0l4.5-1.8a.5.5 0 0 0 .294-.605l-.5-1.7a.5.5 0 0 0-.656-.327L8 10.466zm-.068 1.873.22-.748 3.496 1.311a.5.5 0 0 0 .352 0l3.496-1.311.22.748L8 12.46z"/></svg>
                    {t('nav.certifications')}
                </div>
                <div className="section-icon" onClick={() => ScrollToSection("awards")}>
                ...
                <div className="section-icon" onClick={() => ScrollToSection("contactInfo")}>
