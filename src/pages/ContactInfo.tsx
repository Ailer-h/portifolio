    ...
    return <>
        <section id="contactInfo" className="secondary">
            ...
            <div className="contacts">
                <h2>{t('contactInfo.findMe')}</h2>

                <div className="board">
                    <div onClick={() => copy("+55 (19) 98151-6918", `${t('contactInfo.phone')} ${t('contactInfo.copiedToClipboard')}`)}>
                    ...
                    <a href="https://www.linkedin.com/in/henriqueailer/" target="_blank">
                        <div>
                            ...
                            <h3>Linkedin</h3>
                            <p>https://www.linkedin.com/in/henriqueailer/</p>
                        </div>
                    </a>
