    ...
    return <>
        <section id="projects" className="secondary">
                    ...
                    [...projects].sort((a, b) => {
                        ...
                        const status = project.inDevelopment
                            ...
                            : project.projectEnd instanceof Date
                                ? `${t("projects.finished")} ${formatDate(project.projectEnd)}`
                                : ""
            ...
            <Modal
                ...
                confirmLabel={selectedProject?.codeIsPrivate ? t("projects.privateCode") : "Github"}
                cancelLabel={t("projects.seeDemo")}
                ...
                {selectedProject && <>
                    ...
                    {(selectedProject.projectStart instanceof Date || selectedProject.inDevelopment) && (
                        <p className="modal-dates">
                            ...
                            {selectedProject.inDevelopment ? t("projects.inDevelopment") : formatDate(selectedProject.projectEnd)}
                        </p>
                    )}
