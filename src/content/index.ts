...
export const translations = {
  en: {
    ...
    main: {
      ...
      description:
        'Full-stack Developer with 3+ years of experience in AI, Process Automation, and QA. Built Typeassist at Kyndryl — a Python tool that cut average handling time by 40% across 75+ daily tickets. Mentored 200+ students and guided 30+ AI projects at Samsung Innovation Campus. Currently at ATRIA Corp working with LLM testing, n8n, and AI-driven pipelines under agile methodologies.',
